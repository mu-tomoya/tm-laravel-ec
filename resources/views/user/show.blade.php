                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        @if ($product->imageFirst->filename !== null)
                                            <img src="{{ $s3_url . 'products/' . $product->imageFirst->filename }}">
                                        @else
                                            <img src="">
                                        @endif
                                    </div>
                                    <div class="swiper-slide">
                                        @if ($product->imageSecond->filename !== null)
                                            <img src="{{ $s3_url . 'products/' . $product->imageSecond->filename }}">
                                        @else
                                            <img src="">
                                        @endif
                                    </div>
                                    <div class="swiper-slide">
                                        @if ($product->imageThird->filename !== null)
                                            <img src="{{ $s3_url . 'products/' . $product->imageThird->filename }}">
                                        @else
                                            <img src="">
                                        @endif
                                    </div>
                                    <div class="swiper-slide">
                                        @if ($product->imageFourth->filename !== null)
                                            <img src="{{ $s3_url . 'products/' . $product->imageFourth->filename }}">
                                        @else
                                            <img src="">
                                        @endif
                                    </div>
